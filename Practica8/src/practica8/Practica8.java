...
public class Practica8 {
    ...
    public static void main(String[] args) {
        ...
        Shark tiburon = new Shark("lasky","Gran Tiburon Blanco",7 );
         tiburon.comer();
         tiburon.dormir();
        System.out.println();
         
        Dog perro = new Dog("Husker","Labrador",18 );
        perro.comer();
        perro.dormir();

        
        Animal perrito = new Dog("Rosy", "Husky", 2);
        perrito.comer();
        perrito.dormir();
        perrito.ruido();
        System.out.println("\n");
        ...
        animals[1] = new Dog("Solovino","danese",12);
        animals[2] = new Shark("Megalodon", "Tiburon blanco", 88);
        System.out.println("\n");
