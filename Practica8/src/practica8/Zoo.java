...
public class Zoo {
    ...
    public void agregar() {
        ...
        switch (opc) {
            case 1:
                animales.add(new Perro(CapturaEntrada.capturarCadena("Nombre "), "Husky", /*edad*/5));
                break;
            case 2:
                animales.add(new Tiburon(CapturaEntrada.capturarCadena("Nombre "), "Gran Tiburon Blanco", /*edad*/7));
                break;
            case 3:
                animales.add(new Pinguino("Skypper !!bonitos y gorditos muchachos!!", /*edad*/12));
                
                break;
        }
        Aux++;
        System.out.println("Numero de comtrol del animal --> " + Aux);
    }
